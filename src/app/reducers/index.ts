...
export const getTodo = (state, id) => fromTodos.getTodo(state.todos, id);
export const isDone = (state, id) => fromTodos.isDone(state.todos, id);
export const areAllDone = state => fromTodos.areAllDone(state.todos);
